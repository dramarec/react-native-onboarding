                ...
                {({
                    ...
                    <>
                        ...
                        {touched.password && errors.password &&
                            <Text style={{ fontSize: 12, color: '#FF0D10', marginTop: -10, marginBottom: -3 }}>{errors.password}</Text>
                        }
                        <FormInput
                            name="password"
                        ...
                        {touched.confirmPassword && errors.confirmPassword &&
                            <Text style={{ fontSize: 12, color: '#FF0D10', marginTop: -8, marginBottom: -7 }}>{errors.confirmPassword}</Text>
                        }
